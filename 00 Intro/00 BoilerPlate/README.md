...
Then we will create a hellword.js sample.
...
Install [Node.js and npm](https://nodejs.org/en/) (v6.3.1) if they are not already installed on your computer.
...
- In order to launch webpack, modify the **package.json** file an add a property under the scripts object to run it. Now, our package.json file should looks something like:
...
- Let's run webpack from the command line:
...
- Create now a simple HTML file, and include a script tag that will point to our generated bundle.js file. Now we can click on the html file and see our small piece of code up and running.
